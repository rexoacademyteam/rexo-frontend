const SpecialityItem = ({ title, icon }) => {
    return (
        <div className="px-1 py-2 relative w-1/2 md:w-[14rem]">
            <div
            ...
            <div className="-z-50 absolute top-0 bottom-0 start-0 end-0">
                <div className="w-full h-full bg-gradient-to-r from-pink-300 via-deep-purple-300 to-indigo-400 rounded-full blur-2xl opacity-60"></div>
            </div>
        </div>
    )
}
